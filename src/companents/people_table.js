...
import {selectPeople} from "../redux/reducers/people/selector";
import PeopleTabletPagination from "./people_table_pagination";
        ...
        <>
            ...
            {people.loading ? (
                ...
                <>
                    ...
                    <PeopleTabletPagination
                        page={people.page}
                        totalCount={people.data.count}
                        onChange={changePage}
                    />
                </>
            )}
